 ...
 * start with 2: 用户
 */
error_map.set(ApiErrorNames.UNKNOWN_ERROR, {
    code: -1,
    msg: 'Unknown error!',
    desc: '未知错误'
});
error_map.set(ApiErrorNames.SYSTEM_ERROR, {
    code: 10001,
    msg: 'System error!',
    desc: '系统错误!'
});
error_map.set(ApiErrorNames.PARAMETER_ERROR, {
    code: 10002,
    msg: 'Parameter error!',
    desc: '参数错误!'
});
error_map.set(ApiErrorNames.BAD_REQUEST, {
    code: 10003,
    msg: 'Bad request!',
    desc: '错误的请求',
    status: 400
});
error_map.set(ApiErrorNames.USER_SESSION_INVALID, {
    code: 20001,
    msg: 'Login status is invalid. Please login again!',
    desc: '登录状态失效，请重新登录!',
    status: 401
});
error_map.set(ApiErrorNames.USER_NAME_OR_PASSWORD_ERROR, {
    code: 20002,
    msg: 'Username or password is wrong!',
    desc: '用户名或密码错误'
});
error_map.set(ApiErrorNames.USER_NAME_EXIST, {
    code: 20003,
    msg: 'Username is exist!',
    desc: '用户名已存在'
});
error_map.set(ApiErrorNames.ADMIN_CAN_NOT_DELETE, {
    code: 20004,
    msg: 'Can not delete admin user!',
    desc: 'admin用户不可删除'
});
error_map.set(ApiErrorNames.OLD_PASSWORD_ERROR, {
    code: 20005,
    msg: 'Old password is wrong!',
    desc: '原密码有误'
});
error_map.set(ApiErrorNames.INSUFFICIENT_PRIVILEGE, {
    code: 20006,
